...
| CUDA   | CMAKE_CUDA_ARCHITECTURES | `__CUDA_ARCH_LIST__`                                   | min |
| ------ | ------------------------ | ------------------------------------------------------ |-----|
| `13.0` | `all-major`              | `750,800,900,1000,1100,1200`                           | `750` |
| `13.0` | `all`                    | `750,800,860,870,880,890,900,1000,1030,1100,1200,1210` | `750` | 
| `13.0` | `native`                 | `860`                                                  | `800` |
| `13.0` | `80`                     | `800`                                                  | `800` |
| `13.0` | `80-real`                | `800`                                                  | `800` |
| `13.0` | `80-virtual`             | `800`                                                  | `800` |
| `13.0` | `80;86`                  | `800,860`                                              | `800` |
| `13.0` | `100;80;86`              | `800,860,1000`                                         | `800` |
| `13.0` | `90a`                    | `900`                                                  | `900` |
| `13.0` | `90a;100`                | `900,1000`                                             | `900` |
| `13.0` | `103f`                   | `1030`                                                 | `1030` |
| `13.0` | `121a;121f`              | `1210`                                                 | `1210` |
